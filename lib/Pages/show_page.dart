                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(fontSize: 18  ,fontFamily: "Inria Serif"),
                                ),
                              ),
                            ),
                            /////////////////////////////
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelStyle: TextStyle(fontFamily: "Inria Serif"),
                                 
                                  labelText: '${widget.data['propertyPrice']}',
                            ...
                            Row(
                              children: [
                                ...
                                ElevatedButton(
                                      ...
                                      try {
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          SnackBar(
                                            backgroundColor: Colors.green,
                                            content: Text(
                                                'offer for property Sent Successfuly'),
                                          ),
                                        );
                                      } catch (e) {
                                        print(
                                    ...
                                    child: Text(
                                      "Make offer",
                                      style: TextStyle(fontFamily: "Inria Serif" ,fontSize: 20),
                                ...
                                ElevatedButton(
                                  ...
                                  child: Text(
                                    "Cancel",
                                    style: TextStyle(fontSize: 20 ,fontFamily: "Inria Serif"),
                                  ),
                                ),
                                Spacer(
                                  flex: 1,
              ...
              OutlinedButton.icon(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TourRequestPage(request: widget.data ,),
                      ));
                },
                icon: Icon(
                ...
                label: Text(
                  " Tour Request ", style: TextStyle(fontFamily: "Inria Serif"),
                ),
              ),
            ],
          ),
